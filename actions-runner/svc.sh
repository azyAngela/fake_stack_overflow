...
SVC_NAME="actions.runner.CSE-316-Software-Development-final-project-dingbang-ziyi.Angelas-MBP-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (CSE-316-Software-Development-final-project-dingbang-ziyi.Angelas-MBP-2)"
